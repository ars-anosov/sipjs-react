  ...
  const finalTemplate = (
    ...
    >
      ...
      <Box component="form" onSubmit={handleSubmit} onReset={handleReset}>
        ...
        >
          <Tooltip
            title={isRegistered ? "Разрегистрироваться" : "Зарегистрироваться"}
          >
          ...
          <Stack direction="row" spacing={1}>
            ...
            <Badge
              ...
              overlap="circular"
              invisible={
                !phoneControlRdcr.callUnread || phoneControlRdcr.displayHistory
              }
            >
      ...
      >
        ...
        >
          ...
          <ol>
            ...
            <li>
              <strong>Приоритет баннеров</strong>: Там же
              <ul>
